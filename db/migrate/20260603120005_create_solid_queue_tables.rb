class CreateSolidQueueTables < ActiveRecord::Migration[8.1]
  # Solid Queue tables in the primary database (single-DB setup for development).
  # In production these live in a dedicated `queue` database (see db/queue_schema.rb).
  def change
